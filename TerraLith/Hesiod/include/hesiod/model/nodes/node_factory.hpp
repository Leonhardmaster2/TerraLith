...
DECLARE_NODE_VULKAN(gabor_wave_fbm)
DECLARE_NODE_VULKAN(gain)
...
DECLARE_NODE_VULKAN(clamp)
DECLARE_NODE(clamp_oblique)
DECLARE_NODE_VULKAN(combiner_add)
DECLARE_NODE_VULKAN(combiner_divide)
DECLARE_NODE_VULKAN(combiner_max)
DECLARE_NODE_VULKAN(combiner_min)
DECLARE_NODE_VULKAN(combiner_multiply)
DECLARE_NODE_VULKAN(combiner_subtract)
...
DECLARE_NODE_VULKAN(remap)
DECLARE_NODE_VULKAN(rescale)
...
DECLARE_NODE_VULKAN(select_slope)

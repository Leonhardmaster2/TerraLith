...
void setup_combiner_subtract_node(BaseNode &node)
{
...
void compute_combiner_subtract_node(BaseNode &node)
{
...
#ifdef HESIOD_HAS_VULKAN
bool compute_combiner_subtract_node_vulkan(BaseNode &node)
{
  hmap::Heightmap *p_in1 = node.get_value_ref<hmap::Heightmap>("input 1");
  hmap::Heightmap *p_in2 = node.get_value_ref<hmap::Heightmap>("input 2");

...
```
brew install qt@6 glfw glew glm libpng assimp spdlog opencv eigen nlohmann-json boost
```
...
> **Note:** On macOS, OpenCL is deprecated by Apple. GPU-accelerated nodes default to CPU mode
> but can be switched to GPU in the node settings. OpenGL is limited to version 4.1 Core Profile
> on macOS. Apple Silicon (M1/M2/M3/M4) Macs are supported.
